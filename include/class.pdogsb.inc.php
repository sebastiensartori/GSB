...
*/
	public function getInfosVisiteur($login, $mdp){
		$req = "select utilisateur.id as id, utilisateur.nom as nom, utilisateur.prenom as prenom, utilisateur.comptable as comptable from utilisateur 
...
*/	
	...
	public function majEtatFicheFrais($idVisiteur,$mois,$etat){
        ...
        public function getLesMoisCL(){
            $req = "select fichefrais.mois as mois  from fichefrais where fichefrais.idEtat = 'CL' order by fichefrais.mois DESC ";
            $res = PdoGsb::$monPdo->query($req);
		$lesMois =array();
		$laLigne = $res->fetch();
		while($laLigne != null)	{
        ...
        public function getLesVisiteursCL($unMois){
            $req="select id,nom,prenom from utilisateur join fichefrais on fichefrais.idUtilisateur=utilisateur.id where mois=".$unMois." and fichefrais.idEtat = 'CL'";
            $res = PdoGsb::$monPdo->query($req);
               $lesVisiteurs=array();
               $laLigne = $res->fetch();
		while($laLigne != null)	{
